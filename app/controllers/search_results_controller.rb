class SearchResultsController < ApplicationController
  ...
  def show
    ...
    @amendments_sponsored = AmendmentsSponsored.new(@member.first_name, @member.last_name).number_of_amendments_sponsored
    @amendments_cosponsored = AmendmentsCosponsored.new(@member.first_name, @member.last_name).number_of_amendments_cosponsored
  end
